...
const genSVG = async ({
    ...
    let el = {
        code: ['#_254707715807 > g:nth-child(6) > image', imageSetter, toBase64(await toImg(barcode(wid.replace(/[^0-9]/g, '')), 'png'), 'image/png')],
        pp: ['#_254707715807 > g:nth-child(3) > image', imageSetter, pp],
        text: ['#_254707715807 > text.fil1.fnt0', textSetter, text],
        title: ['#_254707715807 > text.fil2.fnt1', textSetter, title],
        name: ['#_254707715807 > text.fil2.fnt2', textSetter, name],
        bg: ['#_254707715807 > g:nth-child(2) > image', imageSetter, background],
    }
